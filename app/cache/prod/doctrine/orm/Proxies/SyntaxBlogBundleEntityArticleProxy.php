 ...
 */
class SyntaxBlogBundleEntityArticleProxy extends \Syntax\BlogBundle\Entity\Article implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'date', 'titre', 'auteur', 'contenu', 'tags');
    }
